...
public class FileDownloadManager {
         ...
         * @return download id
         */
        public long startDownload(String url, String title, String description,Uri filePath) {
...
//            req.setDestinationInExternalFilesDir(context, Environment.getExternalStorageDirectory(), "LED_update.apk");
            //第二种
...
//            req.setDestinationUri()
            ...
            req.setDestinationUri(filePath);
            // 设置一些基本显示信息
            req.setTitle(title);
        ...
        public long startDownlodApk(String url, String title){
            DownloadManager.Request req = new DownloadManager.Request(Uri.parse(url));
            ...
            req.setNotificationVisibility(DownloadManager.Request.VISIBILITY_VISIBLE_NOTIFY_COMPLETED);
            req.setDestinationInExternalFilesDir(context, Environment.DIRECTORY_DOWNLOADS, "zbh.apk");
